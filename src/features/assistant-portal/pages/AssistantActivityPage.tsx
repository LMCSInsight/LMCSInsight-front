...
/**
 * Read-only “activity” list for assistants: org-wide supervisions and validation
 * status — open a row to view supervision detail (no validate/reject/revise here).
 */
export default function AssistantActivityPage() {
  ...
  return (
    <div className='flex max-w-7xl flex-col gap-5 py-0'>
          ...
          <div className='flex flex-wrap items-start justify-between gap-4'>
            <div>
              <p className='mb-1.5 text-[11px] font-semibold uppercase tracking-widest text-primary/70'>
                {t('assistant.activity.pageEyebrow')}
              </p>
          ...
          <div className='divide-y divide-border'>
            {Array.from({ length: 7 }).map((_, i) => (
              <div key={i} className='flex items-center gap-4 px-4 py-4'>
                ...
                <div className='ml-auto hidden h-4 w-20 animate-pulse rounded-full bg-muted md:block' />
